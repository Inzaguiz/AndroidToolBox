...
import kotlinx.android.synthetic.main.activity_recycle_view_adapter.view.*
...
class RecycleViewAdapter(private val users: ArrayList<OutputAPI>, var mContext: Context): RecyclerView.Adapter<RecycleViewAdapter.UserViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): UserViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.activity_recycle_view_adapter, parent, false)
